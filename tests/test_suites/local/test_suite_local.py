...
class TestLocalOne(object):
    ...
    #---------------------------------------------------------------------------
    #
    def test_issue79(self, rp_setup):
    ...
    #---------------------------------------------------------------------------
    # 
    def test_issue87(self, rp_setup):
    ...
    #---------------------------------------------------------------------------
    #
    def test_issue88(self, rp_setup):
    ...
    #---------------------------------------------------------------------------
    #
    def test_issue133(self, rp_setup):
    ...
    #---------------------------------------------------------------------------
    #
    def test_issue165(self, rp_setup):
    ...
    #---------------------------------------------------------------------------
    #
    def test_issue286(self, rp_setup):
...
class TestLocalThree(object):
    ...
    #---------------------------------------------------------------------------
    #
    def test_state_history(self, rp_setup_state):
