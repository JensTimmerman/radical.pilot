...
PILOT_AGENT_PTYWRAPPER      = 'pilot_agent_ptywrapper'
...
VALID_KEYS = [NAME, LOCAL_JOB_MANAGER_ENDPOINT, LOCAL_FILESYSTEM_ENDPOINT,
              ...
              VALID_ROOTS, BOOTSTRAPPER, PILOT_AGENT, PILOT_AGENT_PTYWRAPPER,
...
class ResourceConfig(attributes.Attributes):
    ...
    **Example**::
    ...
    def __init__(self, seeding_dict=None):
        ...
        self._attributes_register(PILOT_AGENT_PTYWRAPPER,      None, attributes.STRING, attributes.SCALAR, attributes.WRITEABLE)
